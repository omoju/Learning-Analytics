...
nv.models.lineChart = function(flag) {
  ...
  var margin = {top: 30, right: 20, bottom: 50, left: 60},
      ...
      tooltip = function(key, x, y, e, graph) {
            if(flag === 'velocity') {
                return '<h3>' + 'Term ' + x + ' had an average velocity rate of ' + y + '</h3>';
            }
            if(flag === 'daily_active_users') {
                return '<h3>' + 'Day ' + x + ' had ' + y + ' active users </h3>';
            }
 if(flag === 'retention') {
 return '<h3>' + 'Day ' + x + ' has ' + y + ' ' + key +  '</h3>';
 }
        return '<h3>' + key + '</h3>' +
               '<p>' +  y + ' at ' + x + '</p>'
      },
...
*/
 ...
 nv.models.linePlusBarChart = function(flag) {
...
nv.models.stackedAreaChart = function(flag) {
  ...
  var margin = {top: 30, right: 25, bottom: 50, left: 60},
      ...
      tooltip = function(key, x, y, e, graph) {
         ...
         if(flag === 'future_retention') {
         return '<h3>' + key + ' at day ' + x + ' has ' + y +  ' number of renrollments </h3>';
         }
        return '<h3>' + key + '</h3>' +
               '<p>' +  y + ' on ' + x + '</p>'
      },
